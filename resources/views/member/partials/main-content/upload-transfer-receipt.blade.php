        ...
        <form action="{{route('donation.savereceipt', ['id' => $donation->id])}}" method="POST" enctype="multipart/form-data" id="form-receipt">
            ...
            <div class="form-section">
                <div class="row mb-3 text-center">
                    <div class="col-12">
                        <img id="receipt-preview-default" alt="preview" class="img-fluid img-thumbnail" src="{{secure_asset('storage/no-image.jpg')}}">
                        <img id="receipt-preview" alt="preview" class="img-fluid img-thumbnail" src="" style="display:none;">
                        <img id="receipt-loader" src="{{secure_asset('storage/loader/spinner.gif')}}" alt="loader" class="img-fluid"  style="display:none">

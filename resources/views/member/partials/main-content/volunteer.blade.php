                        ...
                        @foreach ($volunteers as $volunteer)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-danger" href="" data-toggle="modal" data-target="#modal" data-backdrop="static" data-keyboard="false" data-modal='{"title":"Hapus History","text":"Hapus proyek ?", "actionUrl":"","delete":"Hapus History", "cancel":"Batalkan","redirectAfter":"","pjax-container":"#mr"}'><i class="far fw fa-trash-alt"></i> Hapus</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>

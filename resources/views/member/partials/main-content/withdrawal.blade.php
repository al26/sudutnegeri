                        ...
                        @foreach (Auth::user()->withdrawals as $w)
                            ...
                            <tr>
                                ...
                                <td><span class="badge badge-{{$badge}}">{{$status}}</span>
                                    @if ($w->status === 'processed' || $w->receipt !== null)
                                    &nbsp;<a href="{{route('file.view', ['path' => $w->receipt])}}" class="badge badge-secondary text-white" target="_blank"><i class="fas fa-receipt"></i> Bukti Pencairan</a>
                                    @endif
                                </td>
                                {{-- <td>

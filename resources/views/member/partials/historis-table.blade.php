            ...
            @foreach ($historis as $history)
                <tr>
                    ...
                    <td>
                        ...
                        @else
                            <span class="btn btn-sm btn-primary my-1 disabled"><i class="far fw fa-edit"></i> Edit</span>
                            <span class="btn btn-sm btn-danger my-1 disabled"><i class="far fw fa-trash-alt"></i> Hapus</span>
                        @endif
                    </td>
                </tr>
            @endforeach

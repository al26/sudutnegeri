...
@section('menu')
    <div class="card">
        ...
        <div class="list-group list-group-flush" id="sudut-menu">
            <a class="list-group-item list-group-item-action dv-menu" id="m-sudut-projects" data-toggle="pjax" data-pjax="main-content" href="{{url('/dashboard/sudut/projects')}}"><i class="fas fw fa-project-diagram mr-2"></i>Proyek Saya</a>
            ...
            @if (Auth::user()->profile->verification->status !== 'verified')
                <a class="list-group-item list-group-item-action dv-menu" id="m-sudut-verify" data-toggle="pjax" data-pjax="main-content" href="{{url('/dashboard/sudut/verify')}}"><i class="fas fw fa-user-check mr-2"></i>Verifikasi Akun</a>
            @endif
        </div>
    </div>

...
@section('menu')
    <div class="nav flex-column nav-pills" id="sudut-menu" aria-orientation="vertical">
        ...
        {{-- <a class="nav-link" id="m-sudut-volunteer" data-toggle="pjax" data-pjax="main-content" href=""><i class="fas fw fa-check-square mr-2" data-fa-transform="grow-3"></i>Data Relawan</a> --}}

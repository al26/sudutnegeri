...
@section('menu')
    <div class="card">
        ...
        <div class="list-group list-group-flush" id="setting-menu">
            <a class="list-group-item list-group-item-action dv-menu" id="m-setting-profile" data-toggle="pjax" data-pjax="main-content" href="{{url('/dashboard/setting/profile')}}"><i class="fas fw fa-user-edit mr-2"></i>Edit Profil</a>
            <a class="list-group-item list-group-item-action dv-menu" id="m-setting-account" data-toggle="pjax" data-pjax="main-content" href="{{url('/dashboard/setting/account')}}"><i class="fas fw fa-user-shield mr-2"></i>Akun</a>
        </div>
    </div>

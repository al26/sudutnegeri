<form action="{{route('avatar.update', ['id' => $id])}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row mb-3 text-center">
        <div class="col-12">
            <img id="profile-preview-default" alt="preview" class="img-fluid img-thumbnail" src="{{asset('storage/profile_pictures/no_image_placeholder.png')}}">
            <img id="profile-preview" alt="preview" class="img-fluid img-thumbnail" src="{{asset('storage/profile_pictures/no_image_placeholder.png')}}" style="display:none;">
            <img id="profile-loader" src="{{asset('storage/loader/spinner.gif')}}" alt="loader" class="img-fluid"  style="display:none">

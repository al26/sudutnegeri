<form method="POST">
    ...
    <div class="form-section">
        ...
        <div class="form-group">
            ...
            <textarea class="form-control the-summernote" id="description" rows="3" name="data[description]"></textarea>
        </div>
        <div class="form-group">
            <label for="location">Lokasi</label>
            <input type="text" class="form-control" id="location" placeholder="Lokasi" name="data[location]">
        </div>
        <div class="form-group">
            <label for="deadline">Tenggat Waktu</label>
            <input type="date" class="form-control" id="deadline" placeholder="Tenggat Waktu" name="data[deadline]">
        </div>
    </div>
    <div class="form-section">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="funding_target" placeholder="Target Dana" name="data[funding_target]">
        </div>
        <div class="form-group">
            <label for="volunteer_spot">Target Relawan</label>
            <input type="text" class="form-control" id="volunteer_spot" placeholder="Target Relawan" name="data[volunteer_spot]">
        </div>
    </div>
</form>
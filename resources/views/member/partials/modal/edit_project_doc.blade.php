<form action="{{route('project.update-doc', ['id' => $id])}}" method="POST" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="custom-file">
            <input type="file" class="custom-file-input" id="attachments" name="data[attachments][]" multiple onchange="javascript:dynamicFileList(this, 'attachments-list', 'attachment-label')" required>

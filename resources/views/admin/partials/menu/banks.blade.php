                        ...
                        @foreach ($banks as $bank)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="" class="btn btn-sm btn-danger text-white my-1" data-toggle="modal" data-target="#modal" data-backdrop="static" data-keyboard="false" data-modal='{"title":"Hapus Bank","text":"Bank {{$bank->bank_name}} akan dihapus dari daftar bank. Lanjutkan hapus ?", "actionUrl":"{{route('banks.destroy', ['id' => encrypt($bank->bank_code)])}}","delete":"Hapus", "cancel":"Batalkan","redirectAfter":"{{route('admin.dashboard', ['menu' => 'banks'])}}","pjax-container":"#ac"}'><i class="far fa-trash-alt"></i> Hapus</a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>

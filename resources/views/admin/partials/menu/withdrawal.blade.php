    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body table-responsive">
                <table id="example" class="table table-striped table-bordered" data-order='{"col":4, "sort":"asc"}'>
                    <thead>
                        <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        ...
                                        <a href="{{route('withdrawal.show', ['id' => encrypt($w->id)])}}" class="btn btn-sm btn-primary text-white" data-toggle="modal" data-target="#modal" data-backdrop="static" data-keyboard="false" data-modal='{"title":"Pencairan Dana Proyek", "lg":true,"cancel":"Batal","edit":"Upload Bukti Tranfer","actionUrl":"{{route('withdrawal.proceed', ['id' => encrypt($w->id),'code'=>'verified'])}}", "redirectAfter":"{{route('admin.dashboard', ['menu' => 'withdrawal'])}}", "pjax-reload":["#ac"]}'>Proses Pencairan</a>
                                    @endif    
                                </td>
                            </tr>
                        @endforeach

    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <form class="custom-form" method="POST" action="{{ route('register') }}">
                ...
                <a href="" class="w-100 mb-2 btn btn-default btn-social fb"><span class="fab fa-facebook-f"></span>Daftar Dengan Akun Facebook</a>
                <a href="" class="w-100 mb-2 btn btn-default btn-social g-plus"><span class="fab fa-google-plus-g"></span>Daftar Dengan Akun Google</a>
                ...
                <div class="form-group mb-0">
                    ...
                    <p>Sudah punya akun ? <a class="btn btn-md btn-link px-0" href="{{ route('register') }}">Masuk</a></p>
                </div>
            </form>
        </div>
    </div>
